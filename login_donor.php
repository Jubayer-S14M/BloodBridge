			...
			<div class="formbox">
				<div class="form">
					<form action="login_donor.php" method="post">
						...
						<input type="text" name="user_name" placeholder="Enter Your User Name" required   autocomplete="off">
						<label>PASSWORD</label>
						<i class="fa fa-eye fa-lg" id="eye" aria-hidden="true"></i>
						<input type="password" name="password" placeholder="Enter Your Password" id="pwd1" required  autocomplete="off">
						<span class="btn">
			...
			<div class="rformbox">
				<div class="form">
					<form action="login_donor.php" method="post">
						...
						<input type="password" name="password" placeholder="Enter Your Password" id="pwd" required  autocomplete="off">
						<span class="btn">
							<input type="submit" name="submit" value="SIGN IN">
						</span>
					</form>
