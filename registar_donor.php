			...
			<div class="scrollbox">
				<div class="registerdonor">
					<form action="process.php" method="POST" id="myform">
							...
							<table>
								...
								<tr>
									<td>
										...
										<input type="text" name="user_full_name" required  autocomplete="off">
									</td>	
									<td>
							...
							<table>
								<tr>
									<td>
										...
										<input type="text" name="user_number"   autocomplete="off">
									</td>
									<td rowspan="2">
										<label>Address:-</label>
						...
						</span><p>I agree to have my contact details broadcasted to the registered donors of Blood_Bridge</p>
				...
				<div class="rlogin">
					...
					<table>
						...
						<tr>
							<td>
								<label>Confirm Password:-</label>
								<input type="text" name="confirm_password" required  autocomplete="off">
							</td>
						</tr>
					</table>
				</div>
				<div class="rcontact">
					...
					<table>
						<tr>
							<td>
								<label>Mobile Number:-</label>
								<input type="text" name="user_number" required  autocomplete="off">
							</td>
						</tr>
						<tr>
							<td>
