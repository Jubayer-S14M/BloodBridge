...
<body>
		...
		<div class="icon1">
			...
			<label>Location <span class="details"><br>DattaPara, Ashulia<br>Savar, Dhaka.</span></label>
		</div>
		<div class="icon2">
			<div class="box">
				<i class="fa fa-phone fa-3x" aria-hidden="true"></i>
			</div>	
			<label>Call Us (24*7) <span class="details"><br>+880 1918365224</span></label>
		</div>
		<div class="icon3">
			<span class="box">
			<i class="fa  fa-envelope-o fa-2x" aria-hidden="true"> </i>
			</span>
			<label>MAIL US<span class="details"><br>jubayersiam703@gmail.com</span></label>
		</div>
		...
		<form id="myform" action="get_in_touch.php" method="post">
			...
			<input type="text" name="contactnumber" placeholder="Contact number"  required autocomplete="off"><br>
